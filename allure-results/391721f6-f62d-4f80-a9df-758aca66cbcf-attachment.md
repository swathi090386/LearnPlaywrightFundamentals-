...
> 9  |         await page.fill('#firstname', 'Swathi');
     |                    ^ Error: page.fill: Test timeout of 30000ms exceeded.
  10 |         await page.fill('#lastname', 'Kumar');
  11 |         await page.selectOption('Gender', 'Female');
  12 |         await page.screenshot({ path: 'screenshot.png' });
  13 |     });
  14 | });
  15 | 
  16 | 
