...
Call log:
  - waiting for locator('[data-testid="profile-date"]')
...
> 14 |        await page.locator('[data-testid="profile-date"]').fill('05/06/2026');
     |                                                           ^ Error: locator.fill: Error: Malformed value
  15 |         // await page.locator('#profile-date').fill('05/06/2026');
  16 |  //await page.getByRole('radio', { name: 'Automation Tester' }).check();
  17 |        // await page.getByRole('radio', { name: 'Manual Testing' }).check();
